...
O banner principal usa a arte Alpine no estilo visual do Fastfetch, com **RokkoDesk** como subtítulo. A arte fica armazenada localmente para não executar Fastfetch nem recalcular informações a cada movimento do menu; o FIGlet permanece como fallback.
